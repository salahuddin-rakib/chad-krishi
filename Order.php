...
<head>
    ...
    <meta name="description" content="Chad Krishi - Let's make make the world green"/>
    <meta name="keywords" content="Let's make life beautiful again"/>
    <meta name="author" content="Chad Krishi"/>

    <!-- Page Title -->
    <title>Chadkrishi - Let's make the world gree</title>

    <!-- Favicon and Touch Icons -->
    <link href="images/bliss.png" rel="shortcut icon" type="image/png">
        ...
        <section id="home">
            <div class="container-fluid p-0">
                ...
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Search Item</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="do_order.php" method="post">
                                    ...
                                    include "server.php";
                                    $query = "SELECT `tree_id`, `tree_name`, `tree_price` FROM `tree` WHERE 1";
                                    $ret = mysqli_query($conn, $query);
                                    if ($ret && mysqli_num_rows($ret)) {
                                        while ($data = mysqli_fetch_assoc($ret)) {
                                            echo "<input type=\"checkbox\" name=\"t" . $data['tree_id'] . "\">  " . $data['tree_name'] . " (PPP: " . $data['tree_price'] .
                                                ") <input type=\"number\" value=\"1\" name=\"q" . $data['tree_id'] . "\" min=\"1\"><br><br>";
                                        }
                                    }
                                    $query = "SELECT `item_id`, `item_name`, `item_price` FROM `item` WHERE 1";
                                    $ret = mysqli_query($conn, $query);
                                    if ($ret && mysqli_num_rows($ret)) {
                                        while ($data = mysqli_fetch_assoc($ret)) {
                                            echo "<input type=\"checkbox\" name=\"i" . $data['item_id'] . "\">  " . $data['item_name'] . " (PPP: " . $data['item_price'] .
                                                ") <input type=\"number\" value=\"1\" name=\"qi" . $data['item_id'] . "\" min=\"1\"><br><br>";
                                        }
                                    }
                                    ?>
