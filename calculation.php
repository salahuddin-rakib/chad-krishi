        ...
        <section id="home">
            <div class="container-fluid p-0">
                ...
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Place Calculation</h3>
                    <div class="section-content bg-white p-30">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="price_calculation.php" method="post">
                                    <?php
                                    include "server.php";
                                ...
                                <div align="center" style="font-size: 20px">
                                    <?php
                                    if (isset($_GET['total'], $_GET['area'], $_GET['message'])) {
                                        echo "Total Price: " . $_GET['total'] . "<br>Total Area Needed: " . $_GET['area'] . "<br>" .$_GET['message'];
                                    }
                                    ?>
                                </div>
