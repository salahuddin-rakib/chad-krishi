                ...
                <div class="container">
                    <nav id="menuzord" class="menuzord default bg-silver-light">
                        ...
                        <ul class="list-inline pull-right flip hidden-sm hidden-xs">
                            <li>
                                <a class="btn btn-colored btn-flat btn-theme-colored mt-15" href="login.php">Log In</a>
                            </li>
                            <li>
                                <a class="btn btn-colored btn-flat btn-theme-colored mt-15" href="registration.php">Registration</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row multi-row-clearfix">
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="causes bg-white maxwidth500 mb-30">
                            ...
                            <div class="causes-details clearfix border-bottom p-15 pt-10 pb-10">
                                <h5 class="font-weight-600 font-16"><a href="#">Conversation with Agriculturist</a></h5>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="causes bg-white maxwidth500 mb-30">
                            ...
                            <div class="causes-details clearfix border-bottom p-15 pt-10 pb-10">
                                <h5 class="font-weight-600 font-16"><a href="#">Order</a></h5>
                                <!-- <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                                <ul class="list-inline font-weight-600 border-top clearfix mt-20 pt-10">
                                  <li class="pull-left pr-0">Raised: $1890</li>
                                  <li class="text-theme-colored pull-right pr-0">Goal: $2500</li>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="causes bg-white maxwidth500 mb-30">
                            ...
                            <div class="causes-details clearfix border-bottom p-15 pt-10 pb-10">
                                <h5 class="font-weight-600 font-16"><a href="#">Tips & Information</a></h5>
                                <!-- <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                                <ul class="list-inline font-weight-600 border-top clearfix mt-20 pt-10">
                                  <li class="pull-left pr-0">Raised: $1890</li>
                                  <li class="text-theme-colored pull-right pr-0">Goal: $2500</li>
                                        ...
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a href="images/gallery/gallery-sm1.jpg"
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        ...
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a href="images/gallery/gallery-sm2.jpg"
                                                       data-lightbox-gallery="gallery"><i
                                                                class="fa fa-picture-o"></i></a>
                                                </div>
                                            </div>
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        ...
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a href="images/gallery/gallery-sm3.jpg"
                                                       data-lightbox-gallery="gallery"><i
                                                                class="fa fa-picture-o"></i></a>
                                                </div>
                                            </div>
                                ...
                                <div class="gallery-item">
                                    <div class="thumb">
                                        ...
                                        <div class="icons-holder">
                                            <div class="icons-holder-inner">
                                                <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                                    <a href="images/gallery/gallery-sm4.jpg"
                                                       data-lightbox-gallery="gallery"><i
                                                                class="fa fa-picture-o"></i></a>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="owl-carousel-1col">
                            ...
                            <div class="item">
                                <div class="testimonial-wrapper text-center">
                                    <div class="content pt-20">
                                        <p class="lead font-20 text-white"><em><i </i>Chad krishi will help you to
                                                produce you needed vegetable or fruits in your own rooftop.</em></p>
