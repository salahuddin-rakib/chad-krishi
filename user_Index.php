...
<head>
    ...
    <meta name="description" content="Chadkrishi"/>
    <meta name="keywords" content="Let's make the world green"/>
    <meta name="author" content="Chadkrishi"/>

    <!-- Page Title -->
    <title>Chadkrishi -Let's make the world green</title>

    <!-- Favicon and Touch Icons -->
    <link href="images/krish.png" rel="shortcut icon" type="image/png">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="widget no-border m-0">
                            <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="user_index.php"><img
                                        src="images/krish.png" alt="">
                                <!-- <img src="images/logo-wide-white.png" alt=""> -->
                                <h5 class="text-white widget-title mb-10">Let's make the world green</h5>
                            </a>
                            <!-- <h5 class="text-white text-uppercase" style="font-size: 48px; font-weight: 700;">Chadkrishi</h5> -->
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <div class="container">
                    <nav id="menuzord" class="menuzord default bg-silver-light">
                        ...
                        <ul class="list-inline pull-right flip hidden-sm hidden-xs">
                            <li>
                                <a class="btn btn-colored btn-flat btn-theme-colored mt-15" href="logout.php">Log
                                    Out</a>
                            </li>
                            <li>
                            <li>
                                <a class="btn btn-colored btn-flat btn-theme-colored mt-15" href="conversation.php">Conversation
                                    with Agriculturist</a>
                            </li>
                            <li>
                                <a class="btn btn-colored btn-flat btn-theme-colored mt-15" href="view_message.php">View Message</a>
                            </li>
                            </li>
                        </ul>
                    </nav>
    ...
    <div class="main-content">
                    ...
                    <div class="rev_slider rev_slider_default" data-version="5.0">
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                                ...
                                data-thumb="images/bg/bg14.jpg" data-rotate="0" data-saveperformance="off"
                                data-title="Slide 1" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="images/bg/bg14.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                            ...
                            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                                ...
                                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway bg-theme-colored-transparent pl-20 pr-20"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 7; white-space: nowrap; font-weight:600;">MAKE THE WORLD GREEN
                                </div>
                            ...
                            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                                data-easein="default" data-easeout="default" data-masterspeed="default"
                                data-thumb="images/bg/bg7.jpg" data-rotate="0" data-saveperformance="off"
                                data-title="Slide 3" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="images/bg/bg7.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                                     data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                                <!-- LAYERS -->
                                ...
                                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway pr-20 pl-20"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 7; white-space: nowrap; font-weight:600;"><span class="">Get</span>
                                </div>
                                ...
                                <div class="tp-caption tp-resizeme text-uppercase text-white font-raleway"
                                     ...
                                     data-splitout="none"
                                     data-responsive_offset="on"
                                     style="z-index: 7; white-space: nowrap; font-weight:600;">A Healthy Life
                                </div>
        ...
        <section id="about">
            <div class="container pb-30">
                <div class="section-content">
                    <div class="row">
                        <div class="col-md-6">
                            <img class="img-fullwidth" src="images/about/about4.jpg" alt="">
                            <h3 class="line-bottom">Who We Are?</h3>
                            <p>Roofs are more than just functional components for protecting building materials. Roofs
                                give character to individual buildings and entire city districts. But roofs are also
                                coming to be viewed more and more as reserve urban areas for creative planners looking
                                for socially responsible concepts that counteract the loss of natural living spaces.
                                Green roofs are extending the variety of contemporary architecture. They fill the
                                concept of roof landscape with new life," Nature - increasingly hemmed in by buildings
                                and paved surfaces - returns as an attractive green element in residential, recreational
                                and work environments.Chad krishi- are pioneers and innovators in terms of extensive and
                                intensive roof greening. Research projects and innovative systems developed by Chad
                                krishi inspire architects and demanding clients to plan both private and large public
                                buildings in a holistic and sustainable way. </p>
                            <!-- <a class="text-theme-colored font-13" href="page-about1.php">Read More ?</a> -->
                        </div>
                        <div class="col-md-6">
                            <h3 class="line-bottom mt-0 mt-sm-30">Our Mission</h3>
                            <p class="mb-30">Chadkrishi has been developed to engeen every rooftop to contribute to
                                restrict global warming.</p>
                            <p> Chad krishi believes in the green rooftop.</p>
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="icon-box p-0 mb-30">
                                        <a class="icon icon-sm pull-left sm-pull-none flip bg-theme-colored mb-sm-15 mb-0 mr-10"
                                           href="#">
                                            <i class="flaticon-charity-shelter text-white font-36"></i>
                                        </a>
                                        <h4 class="icon-box-title m-0 mb-5">Shelter for Poor</h4>
                                        <p class="text-gray mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Et magni temporibus voluptates adipisicing..</p>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="icon-box p-0 mb-30">
                                        ...
                                        <h4 class="icon-box-title m-0 mb-5">Social Development</h4>
                                        <p class="text-gray mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Et magni temporibus voluptates adipisicing..</p>
                                        <!-- <a href="#" class="text-theme-colored font-13">Read More ?</a> -->
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6">
                                    <div class="icon-box p-0 mb-30">
                                        <a class="icon icon-sm pull-left sm-pull-none flip bg-theme-colored mb-sm-15 mb-0 mr-10"
                                           href="#">
                                            <i class="flaticon-charity-responsible-use-of-water text-white font-36"></i>
                                        </a>
                                        <h4 class="icon-box-title m-0 mb-5">Safe Drinking Water</h4>
                                        <p class="text-gray mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing
                                            elit. Et magni temporibus voluptates adipisicing..</p>
                                        <!-- <a href="#" class="text-theme-colored font-13">Read More ?</a> -->
                                    </div>
        ...
        <section id="services" class="bg-silver-light">
            <div class="container pb-40">
                <div class="section-title text-center">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="text-uppercase line-bottom-center mt-0">Our Services</h2>
                            <p>We are trying to make every rooftop green</p>
                        </div>
                    </div>
                </div>
                ...
                <a class="btn btn-block btn-dark" href="calculation.php">Calculation </a>
                ...
                <a class="btn btn-block btn-dark" href="order.php">Order </a>
                <!-- <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline font-weight-600 border-top clearfix mt-20 pt-10">
                  <li class="pull-left pr-0">Raised: $1890</li>
                  <li class="text-theme-colored pull-right pr-0">Goal: $2500</li>
                ...
                <a class="btn btn-block btn-dark" href="tips.php">Tips and Information</a>
...
<!-- Divider: Funfact -->
<section class="divider parallax layer-overlay overlay-theme-colored-9" data-bg-img="images/bg/bg14.jpg"
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 mb-md-50">
                <div class="funfact text-center">
                    ...
                    <h5 class="text-white text-uppercase font-weight-600">Agriculturiest</h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 mb-md-50">
                <div class="funfact text-center">
                    ...
                    <h2 data-animation-duration="2000" data-value="675"
                        class="animate-number text-white font-42 font-weight-500 mt-0 mb-0">0</h2>
                    <h5 class="text-white text-uppercase font-weight-600">Successful Projects</h5>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 mb-md-50">
                <div class="funfact text-center">
                    ...
                    <h2 data-animation-duration="2000" data-value="1248"
                        class="animate-number text-white font-42 font-weight-500 mt-0 mb-0">0</h2>
                    <h5 class="text-white text-uppercase font-weight-600">Available members</h5>
                </div>
            </div>
        ...
        <div class="section-title text-center">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <p>Chadkrishi photo gallery of the projects are done so far...</p>
                </div>
            </div>
        </div>
        <div class="section-content">
                                ...
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a href="images/gallery/gallery-sm1.jpg" data-lightbox-gallery="gallery"><i
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                ...
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a href="images/gallery/gallery-sm2.jpg" data-lightbox-gallery="gallery"><i
                                                        class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                ...
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a href="images/gallery/gallery-sm3.jpg" data-lightbox-gallery="gallery"><i
                                                        class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="gallery-item">
                            <div class="thumb">
                                ...
                                <div class="icons-holder">
                                    <div class="icons-holder-inner">
                                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                                            <a href="images/gallery/gallery-sm4.jpg" data-lightbox-gallery="gallery"><i
                                                        class="fa fa-picture-o"></i></a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="section-title text-center">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <p>We are helping people to build roofing agriculture.</p>
                </div>
            </div>
        </div>
        <div class="section-content">
...
<section class="divider parallax layer-overlay overlay-dark-6" data-stellar-background-ratio="0.5"
                    ...
                    <!-- <div class="item">
                      <div class="testimonial-wrapper text-center">
                        <div class="content pt-20">
                          <p class="lead font-20 text-white"><em><i class="fa fa-quote-left font-20 mr-15"></i>WE hereby urge all of you to stand against all odds and evils for ultimate win for humanity and a society full of parity and justice.</em></p>
                          <div class="thumb mb-20"><img class="img-circle border-2px" alt="" src="#"></div>
                          <h4 class="author text-theme-colored font-weight-600 mb-0">Foyez Uddin Mia</h4>
                          <h6 class="title text-white mt-0 mb-15">Chairman, Chadkrishi</h6>
                        </div>
                      </div>
                    </div> -->
                    <div class="item">
                        <div class="testimonial-wrapper text-center">
                            <div class="content pt-20">
                                <p class="lead font-20 text-white"><em><i </i>Chad krishi will help you to produce you
                                        needed vegetable or fruits in your own rooftop.</em></p>
                                <div class="thumb mb-20"><img class="img-circle border-2px" alt=""
...
<footer id="footer" class="footer" data-bg-img="images/footer-bg.png" data-bg-color="#25272e">
        ...
        <div class="row border-bottom-black">
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <p>United International University, Dhaka -1212</p>
                    <ul class="list-inline mt-5">
                        <li class="m-0 pl-10 pr-10"><i class="fa fa-phone text-theme-colored mr-5"></i> <a
                                    class="text-gray" href="#">+88 01967-579586</a></li>
                        <li class="m-0 pl-10 pr-10"><i class="fa fa-envelope-o text-theme-colored mr-5"></i> <a
    ...
    <div class="footer-bottom bg-black-333">
        <div class="container pt-15 pb-10">
            <div class="row">
                <div class="col-md-6">
                    <p class="font-11 text-black-777 m-0">Copyright &copy;2016 Chadkrishi. All Rights Reserved</p>
                </div>
