                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="widget no-border m-0">
                            <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="agriculturist_index.php"><img
                ...
                <div class="container">
                    <nav id="menuzord" class="menuzord default bg-silver-light">
                        <ul class="menuzord-menu">
                            <li><a href="agriculturist_index.php">Home</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <section id="home">
            <div class="container-fluid p-0">
                ...
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Message</h3>
                    <div class="section-content bg-white p-30">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                include "server.php";
                                $userId = $_SESSION['id'];
                                $query = "SELECT m.`message_id`, u.name, m.`message` FROM `message` m JOIN user u ON(m.`user_id3` = u.id) WHERE 1";
                                $ret = mysqli_query($conn, $query);
                                if ($ret && mysqli_num_rows($ret) > 0) {
                                    while ($data = mysqli_fetch_assoc($ret)) {
                                        echo $data['message'] . "<br>" . "By " . $data['name'] . "<br><br>";
                                    }
                                }
                                ?>
                                <!-- Job Form Validation-->
