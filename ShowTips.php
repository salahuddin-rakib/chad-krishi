        ...
        <section id="home">
            <div class="container-fluid p-0">
                ...
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Tips</h3>
                                ...
                                <form id="volunteer_apply_form" name="job_apply_form" action="" method="post"
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            include "server.php";
                                            $treeName = $_POST['tips'];
                                            $query = "SELECT `tips`, `deaseas`, `medicine` FROM `tips` WHERE `tree_id1` = 
							(SELECT `tree_id` FROM `tree` WHERE `tree_name` LIKE \"%" . $treeName . "%\" LIMIT 1)";
                                            $ret = mysqli_query($conn, $query);
                                            if ($ret && mysqli_num_rows($ret) > 0) {

                                                $ret = mysqli_fetch_assoc($ret);
                                                echo "Tips:<br/>" . $ret['tips'] . "<br/>Deaseas:<br/>" . $ret['deaseas'] . "<br/>Medicine:<br/>" . $ret['medicine'];
                                            } else {
                                                echo "No tips found";
                                            }
                                            ?>
