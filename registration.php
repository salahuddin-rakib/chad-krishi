...
<head>
    ...
    <meta name="description" content="krishi - Let's make the world green"/>
    <meta name="keywords" content="Let's make life beautiful again"/>
    <meta name="author" content="Krishi"/>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="widget no-border m-0">
                            ...
                            <!-- <h5 class="text-white text-uppercase" style="font-size: 48px; font-weight: 700;">Chad krishi</h5> -->
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
    ...
    <div class="main-content">
        ...
        <section id="home">
            <div class="container-fluid p-0">
                <!-- <div class="mfp-wrap mfp-close-btn-in mfp-align-top mfp-auto-cursor mfp-ready" tabindex="-1" style="overflow: hidden scroll;"><div class="mfp-container mfp-ajax-holder mfp-s-ready"><div class="mfp-content"><section class=""> -->
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Registration</h3>
                    <div class="section-content bg-white p-30">
                        <div class="row">
                            <div class="col-md-12">
                                <form id="volunteer_apply_form" name="signup_form" action="registration.php"
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                ...
                                                <input id="password1" name="password1" type="password"
                                                       ...
                                                       class="form-control required password" aria-required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                <label for="phone">Phone_Number
                                                    <small>*</small>
                                                </label>
                                                <input id="phone" name="phone" type="phone"
                                                       placeholder="Enter phone number" required=""
                                                       class="form-control required phone" aria-required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                ...
                                                <input id="location" name="location" type="location"
                                                       ...
                                                       class="form-control required location" aria-required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input id="registration" name="registration" class="form-control" type="hidden"
                                               value="">
                                        <button type="submit" name="registration"
                                                class="btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10"
                                                data-loading-text="Please wait..."> Registration
                                        </button>
                                    </div>
                                    <p>
                ...
                <!-- <button title="Close (Esc)" type="button" class="mfp-close">�</button></section></div><div class="mfp-preloader">Loading...</div></div></div>
                      </div>
                    </section> -->
            ...
            if (isset($_POST['registration'])) {
                ...
                if (($_POST['password1'] == $_POST['password2'])) {
                    ...
                    $sql = "INSERT INTO `user` (`password`, `name`, `email`, `number`,`location`, type)  VALUES ( '" . $_POST['password1'] . "', '" . $_POST['name'] . "', '" . $_POST['email'] . "','" . $_POST['phone'] . "', '" . $_POST['location'] . "', '" . $_POST['type'] . "')";
                    ...
                    if (!$res) {
                        echo "<script>
                        alert('Can not register.Try again...');
            ...
            <footer id="footer" class="footer" data-bg-img="images/footer-bg.png" data-bg-color="#25272e">
                            ...
                            <div class="widget dark">
                                ...
                                <ul class="list-inline mt-5">
                                    ...
                                    <li class="m-0 pl-10 pr-10"><i class="fa fa-envelope-o text-theme-colored mr-5"></i>
                                        <a class="text-gray" href="#">chadkrishi@gmail.com</a></li>
                ...
                <div class="footer-bottom bg-black-333">
                    <div class="container pt-15 pb-10">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="font-11 text-black-777 m-0">Copyright &copy;2016 chad krishi. All Rights
                                    Reserved</p>
                            </div>
