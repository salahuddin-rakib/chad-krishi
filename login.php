...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM `user` WHERE '$user'= email AND '$pass'= password ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        } elseif ($type === 'agriculturist') {
            $_SESSION['id'] = $row['id'];
            $_SESSION['type'] = $row['type'];
            header('location: agriculturist_Index.php');
        } else {
        ...
        <section id="home">
            <div class="container-fluid p-0">
                ...
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Log In</h3>
                    <div class="section-content bg-white p-30">
                        <div class="row">
                            <div class="col-md-12">

                                <form id="volunteer_apply_form" name="job_apply_form" action="" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" name="login"
                                                ...
                                                data-loading-text="Please wait...">Log In
                                        </button>
                                    </div>
                                    <p>
                                        Not a member? <a href="registration.php">Registration</a>
                                    </p>
                                </form>
                                <!-- Job Form Validation-->
            ...
            <footer id="footer" class="footer" data-bg-img="images/footer-bg.png" data-bg-color="#25272e">
                ...
                <div class="footer-bottom bg-black-333">
                    <div class="container pt-15 pb-10">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="font-11 text-black-777 m-0">Copyright &copy;2016 Chadkrishi. All Rights
                                    Reserved</p>
                            </div>
