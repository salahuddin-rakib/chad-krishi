        ...
        <section id="home">
            <div class="container-fluid p-0">
                ...
                <div class="container" style="max-width: 700px;">
                    <h3 class="bg-theme-colored p-15 mb-0 text-white">Search Tree Name</h3>
                    <div class="section-content bg-white p-30">
                        <div class="row">
                            <div class="col-md-12">

                                <form id="volunteer_apply_form" name="job_apply_form" action="ShowTips.php"
                                      method="post" enctype="multipart/form-data" novalidate="novalidate">
                            </div>
                            <div class="col-sm-6">
                                <input name="tips" class="form-control required tips" type="tips"
