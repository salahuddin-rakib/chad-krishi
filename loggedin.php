                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="widget no-border m-0">
                            <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="index.php"><img
                            ...
                            <li>
                                <div class="form-group">
                                    ...
                                    <button type="submit" name="login"
                                            class="btn btn-colored btn-flat btn-theme-colored mt-15"
                                            data-loading-text="Please wait...">Conversation with Agriculturist
                                    </button>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="container pb-40">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" name="login" class="btn btn-block btn-dark"
                            data-loading-text="Please wait..."> Calculation
                    </button>
                </div>
                ...
                <div class="form-group">
                    <input id="form_botcheck" name="form_botcheck" class="form-control" type="hidden" value="">
                    <button type="submit" name="login" class="btn btn-block btn-dark"
                            data-loading-text="Please wait...">Order
                    </button>
                </div>
                <!-- <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline font-weight-600 border-top clearfix mt-20 pt-10">
                ...
                <div class="form-group">
                    <input id="form_botcheck" name="form_botcheck" class="form-control" type="hidden" value="">
                    <button type="submit" name="login" class="btn btn-block btn-dark"
                            data-loading-text="Please wait...">Tips and Information
                    </button>
                </div>
                <!-- <p>Lorem ipsum dolor sit amet, consect adipisicing elit. Praesent quos sit.</p>
                <ul class="list-inline font-weight-600 border-top clearfix mt-20 pt-10">
